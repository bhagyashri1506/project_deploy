      ...
      <main class="layout-main flex-1">
          ...
          <hgroup className="flex-grow flex flex-col gap-05lh">
              ...
              <div className="flex-shrink-0 ml-3 flex items-center">
                <script
                  dangerouslySetInnerHTML={{
                    __html:
                      '{"content": "yoadtew/zero-shot-image-to-text", "label": "Copy model name"}',
                  }}
                  id="react-component-props-9ef0abcb-fbf6-47f7-a66e-c32eebf48ebd"
                  type="application/json"
                />

                <div
                  data-component="CopyIconButton"
                  data-props="react-component-props-9ef0abcb-fbf6-47f7-a66e-c32eebf48ebd"
                >
                  <button
            ...
            <ul className="flex gap-lh">
              ...
              <li className="whitespace-nowrap">
                ...
                <a
                  href="https://github.com/YoadTew/zero-shot-image-to-text"
                  target="_blank"
                >
                  GitHub
                </a>
              ...
              <li className="whitespace-nowrap">
                ...
                <a href="https://arxiv.org/abs/2111.14447" target="_blank">
                  Paper
                </a>
              </li>
            </ul>
        ...
        <a
          ...
          >
            ...
            Versions
            <span className="text-shade text-sm font-mono">(7f2735ba)</span>
          </a>
        </div>
        <Outlet />
      </main>
