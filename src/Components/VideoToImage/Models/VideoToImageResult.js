      ...
      <main class="layout-main flex-1">
          ...
          <hgroup className="flex-grow flex flex-col gap-05lh">
              ...
              <div>
                <h3>
                  <span className="text-shade">
                    <a href="/soykertje">soykertje</a>
                  </span>

                  <span className="text-shade px-1">/</span>

                  <span className="block md:inline">whisper</span>
                </h3>
              </div>
              ...
              <div className="flex-shrink-0 ml-3 flex items-center">
                <script
                  dangerouslySetInnerHTML={{
                    __html:
                      '{"content": "soykertje/whisper", "label": "Copy model name"}',
                  }}
                  id="react-component-props-887a456f-aa57-4c38-98a1-65185766c294"
                  type="application/json"
                />

                <div
                  data-component="CopyIconButton"
                  data-props="react-component-props-887a456f-aa57-4c38-98a1-65185766c294"
                >
                  <button
            ...
            <ul className="flex gap-lh">
              ...
              <li className="whitespace-nowrap">
                ...
                <a
                  href="https://github.com/Soykertje/cog-whisper"
                  target="_blank"
                >
                  GitHub
                </a>
              ...
              <li className="whitespace-nowrap">
                ...
                <a
                  href="https://github.com/Soykertje/cog-whisper/blob/main/LICENSE"
                  target="_blank"
                >
                  License
                </a>
        ...
        <div className="tabs flex gap-2 md:gap-2lh mb-lh md:mb-2lh border-b border-hairline">
          ...
          >
            ...
            Versions
            <span className="text-shade text-sm font-mono">(20de0792)</span>
          </a>
        </div>
        <Outlet />
      </main>
...
export default VideoToImageResult;
