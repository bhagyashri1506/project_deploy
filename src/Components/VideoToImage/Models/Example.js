...
const VToIExample = () => {
  return (
    <>
      <div
        data-component="ExampleList"
        data-props="react-component-props-a2741a49-f876-487e-b8d9-2de886575886"
      >
        <div>
          <div className="mb-lh pb-lh " id="hfagulrblado4gvy6nz3bgplm4">
            <div>
              <div className="flex flex-col md:flex-row gap-2lh md:gap-lh">
                <div className="flex-1 min-w-0">
                  <h4 className="md:hidden mb-lh">Input</h4>
                  <div className="mb-lh">
                    <div>
                    ...
                    <div>
                      ...
                      <pre className="overflow-x-auto overflow-y-auto whitespace-pre-wrap max-h-96">
                        <code className="output w-full">large-v2</code>
                      </pre>
                    </div>
                    <div>
                      <p className="mb-2">transcription</p>
                      <pre className="overflow-x-auto overflow-y-auto whitespace-pre-wrap max-h-96">
                        <code className="output w-full">plain text</code>
                      </pre>
                    </div>
                    <div>
                      <p className="mb-2">suppress_tokens</p>
                      <pre className="overflow-x-auto overflow-y-auto whitespace-pre-wrap max-h-96">
                        <code className="output w-full">-1</code>
                      </pre>
                    </div>
                    <div>
                      <p className="mb-2">word_timestamps</p>
                      <div className="mb-1">
                        <input
                    ...
                    <div>
                      <p className="mb-2">logprob_threshold</p>
                      <pre className="overflow-x-auto overflow-y-auto whitespace-pre-wrap max-h-96">
                        <code className="output w-full">-1</code>
                      </pre>
                    </div>
                    <div>
                      <p className="mb-2">no_speech_threshold</p>
                      <pre className="overflow-x-auto overflow-y-auto whitespace-pre-wrap max-h-96">
                        <code className="output w-full">0.6</code>
                      </pre>
                    </div>
                    <div>
                      <p className="mb-2">condition_on_previous_text</p>
                      <div className="mb-1">
                        <input
                          className="w-5 h-5 relative top-1 mr-2"
                          defaultChecked
                    ...
                    <div>
                      <p className="mb-2">compression_ratio_threshold</p>
                      <pre className="overflow-x-auto overflow-y-auto whitespace-pre-wrap max-h-96">
                        <code className="output w-full">2.4</code>
                      </pre>
                    </div>
                    <div>
                      <p className="mb-2">temperature_increment_on_fallback</p>
                      <pre className="overflow-x-auto overflow-y-auto whitespace-pre-wrap max-h-96">
                        <code className="output w-full">0.2</code>
                      </pre>
                    </div>
                  </div>
                  <a
                    className="form-button-secondary relative"
                    href="/soykertje/whisper?prediction=hfagulrblado4gvy6nz3bgplm4"
                  >
                    <svg
                      className="icon"
                      fill="none"
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="md:hidden mb-lh">Output</h4>
                  <div className="mb-lh">
                        ...
                        <div className="mb-lh">
                          <div>
                            ...
                            <pre className="overflow-x-auto overflow-y-auto whitespace-pre-wrap max-h-96">
                              <code className="output w-full">
                                {" "}
                                This is the Micro Machine Man presenting the
                                most midget miniature motorcade of micro
                                machines. Each one has dramatic details,
                                terrific trim, precision paint jobs, plus
                                incredible micro machine pocket play sets.
                                There's a police station, fire station,
                                restaurant, service station, and more. Perfect
                                pocket portables to take anyplace. And there are
                                many miniature play sets to play with and each
                                one comes with its own special edition micro
                                machine vehicle and fun fantastic features that
                                miraculously move. Raise the boat lift at the
                                airport, marina, man the gun turret at the army
                                base, clean your car at the car wash, raise the
                                toll bridge. And these play sets fit together to
                                form a micro machine world. Micro machine pocket
                                play sets so tremendously tiny, so perfectly
                                precise, so dazzlingly detailed, you'll want to
                                pocket them all. Micro machines and micro
                                machine pocket play sets sold separately from
                                Galoob. The smaller they are, the better they
                                are.
                              </code>
                            </pre>
                          </div>
      ...
      <div className="mx-auto my-2lh text-center">
        <p className="mb-lh">Want to make some of these yourself?</p>

        <a className="form-button" href="/soykertje/whisper">
          Run this model
        </a>
      </div>
