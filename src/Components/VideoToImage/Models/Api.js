  ...
  return (
    <>
      <div
        ...
        data-props="react-component-props-39a83617-3be3-4ef1-b473-e52a74b481bc"
      >
        <div className="mb-lh">
          <div
            ...
            <div data-reach-tab-panels="">
              ...
              >
                ...
                `}
                      ...
                      <span className="hljs-string">
                        "ad9374d1b385c86948506b3ad287af9fca23e796685221782d9baa2bc43f14a9"
                      </span>
                      ,<span className="hljs-attr">input</span>
                      {`: {
                `}
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      {`curl -s -X POST \
                -d '{"version": "ad9374d1b385c86948506b3ad287af9fca23e796685221782d9baa2bc43f14a9", "input": {"video": "..."}}' \
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      cog predict
                      r8.im/fofr/video-to-frames@sha256:ad9374d1b385c86948506b3ad287af9fca23e796685221782d9baa2bc43f14a9
                      -i video=@path/to/file \ -i fps=... \ -i
                      extract_all_frames=...
                    </code>
                  </pre>
                  <div className="absolute right-2 top-0 bottom-0 h-full opacity-0 group-hover:opacity-100 flex top-2 items-start">
          ...
          <ul className="content-container">
            <li className="pb-lh border-b border-hairline">
              ...
              <div>Video to split into frames</div>
            </li>
            <li className="pb-lh border-b border-hairline">
              <a
                className="inline-block no-focus no-underline"
              ...
              >
                <h5 className="pt-lh pb-05lh with-anchor-hash">
                  <code>fps</code> <em className="text-shade">integer</em>
                </h5>
              </a>
              <div>
