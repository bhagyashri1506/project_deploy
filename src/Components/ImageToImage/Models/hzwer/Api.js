  ...
  return (
    <>
      <div
        ...
        data-props="react-component-props-e3ce7f56-b93e-4457-891b-9d17b7216477"
      >
        <div className="mb-lh">
          <div
              ...
              >
                ...
                `}
                      ...
                      <span className="hljs-string">
                        "hzwer/iccv2019-learningtopaint:1da220059cf4eb1de6cdbca18378f1c34ae0fdfec8d18aa5570dd224b0d18284"
                      </span>
                      {`,
                {
                `}
                ...
                `}
                      ...
                      <span className="hljs-string">
                        "1da220059cf4eb1de6cdbca18378f1c34ae0fdfec8d18aa5570dd224b0d18284"
                      </span>
                      ,<span className="hljs-attr">input</span>
                      {`: {
                `}
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      {`curl -s -X POST \
                -d '{"version": "1da220059cf4eb1de6cdbca18378f1c34ae0fdfec8d18aa5570dd224b0d18284", "input": {"image": "..."}}' \
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      cog predict
                      r8.im/hzwer/iccv2019-learningtopaint@sha256:1da220059cf4eb1de6cdbca18378f1c34ae0fdfec8d18aa5570dd224b0d18284
                      -i image=@path/to/file \ -i renderer=...
                    </code>
                  </pre>
                  <div className="absolute right-2 top-0 bottom-0 h-full opacity-0 group-hover:opacity-100 flex top-2 items-start">
                    <button className="p-2 bg-white border-gray-300 text-gray-800 hover:text-gray-500 focus:outline-none">
          ...
          <ul className="content-container">
            ...
            <li className="pb-lh border-b border-hairline">
              ...
              >
                <h5 className="pt-lh pb-05lh with-anchor-hash">
                  <code>renderer</code> <em className="text-shade">string</em>
                </h5>
              </a>
              <div>type of renderer</div>
