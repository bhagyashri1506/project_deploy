    ...
    <>
      ...
      <main class="layout-main flex-1">
          ...
          <hgroup className="flex-grow flex flex-col gap-05lh">
              ...
              <div>
                <h3>
                  <span className="text-shade">
                    <a href="/haoheliu">haoheliu</a>
                  </span>

                  <span className="text-shade px-1">/</span>

                  <span className="block md:inline">audio-ldm</span>
                </h3>
              </div>
              ...
              <div className="flex-shrink-0 ml-3 flex items-center">
                <script
                  dangerouslySetInnerHTML={{
                    __html:
                      '{"content": "haoheliu/audio-ldm", "label": "Copy model name"}',
                  }}
                  id="react-component-props-6236522e-8510-471b-84fa-e1b86581e6e2"
                  type="application/json"
                />

                <div
                  data-component="CopyIconButton"
                  data-props="react-component-props-6236522e-8510-471b-84fa-e1b86581e6e2"
                >
                  <button
            ...
            <ul className="flex gap-lh">
              ...
              <li className="whitespace-nowrap">
                ...
                <a href="https://github.com/haoheliu/AudioLDM" target="_blank">
                  GitHub
                </a>
              </li>
              ...
              <li className="whitespace-nowrap">
                ...
                <a href="https://arxiv.org/abs/2301.12503" target="_blank">
                  Paper
                </a>
              </li>
              ...
              <li className="whitespace-nowrap">
                ...
                <a
                  href="https://github.com/haoheliu/AudioLDM/blob/main/LICENSE"
                  target="_blank"
                >
                  License
                </a>
        ...
        <div className="tabs flex gap-2 md:gap-2lh mb-lh md:mb-2lh border-b border-hairline">
          <a
            className="tab "
            href="/collection/texttospeechresult/demo"
          >
            <svg
              className="icon"
              fill="none"
          ...
          <a className="tab " href="/collection/texttospeechresult/api">
            <svg
              className="icon"
              height="24"
              viewBox="0 0 24 24"
          ...
          <a className="tab " href="/collection/texttospeechresult/example">
            <svg
              className="icon"
              fill="none"
              height="24"
          ...
          <a className="tab " href="/collection/texttospeechresult/versions">
            <svg
              className="icon"
              fill="none"
              height="24"
            ...
            Versions
            <span className="text-shade text-sm font-mono">(b61392ad)</span>
          </a>
        </div>
        <Outlet />
      </main>
