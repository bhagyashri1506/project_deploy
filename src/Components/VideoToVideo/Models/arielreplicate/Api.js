  ...
  return (
    <>
      <div
        ...
        data-props="react-component-props-ed2cf27f-d910-478f-af63-ddc11d81bb11"
      >
        <div className="mb-lh">
          <div
            ...
            <div data-reach-tab-panels="">
              ...
              >
                ...
                `}
                      ...
                      {`: {
                `}
                      <span className="hljs-attr">input_video</span>:{" "}
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-python !p-0 hljs">
                      ...
                      {`={`}
                      <span className="hljs-string">"input_video"</span>:{" "}
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      {`curl -s -X POST \
                -d '{"version": "73d2128a371922d5d1abf0712a1d974be0e4e2358cc1218e4e34714767232bac", "input": {"input_video": "..."}}' \
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      cog predict
                      r8.im/arielreplicate/robust_video_matting@sha256:73d2128a371922d5d1abf0712a1d974be0e4e2358cc1218e4e34714767232bac
                      -i input_video=@path/to/file \ -i output_type=...
                    </code>
                  </pre>
                  <div className="absolute right-2 top-0 bottom-0 h-full opacity-0 group-hover:opacity-100 flex top-2 items-start">
                    <button className="p-2 bg-white border-gray-300 text-gray-800 hover:text-gray-500 focus:outline-none">
          ...
          <ul className="content-container">
            <li className="pb-lh border-b border-hairline">
              <a
                className="inline-block no-focus no-underline"
                href="#input-input_video"
                id="input-input_video"
              >
                <h5 className="pt-lh pb-05lh with-anchor-hash">
                  <code>input_video</code> <em className="text-shade">file</em>
                </h5>
              </a>
              <div>Video to segment.</div>
            </li>
            <li className="pb-lh border-b border-hairline">
              <a
                className="inline-block no-focus no-underline"
                href="#input-output_type"
              ...
              <div>An enumeration.</div>
              <div className="mt-05lh">
                Allowed values:
                <span>
                  <code>green-screen</code>,{" "}
                </span>
                <span>
                  <code>alpha-mask</code>,{" "}
                </span>
                <span>
                  <code>foreground-mask</code>
                </span>
              </div>
              <div className="mt-05lh">
                Default value: <code>green-screen</code>
              </div>
            </li>
          </ul>
          <a
