      ...
      <main class="layout-main flex-1">
        ...
        <div className="tabs flex gap-2 md:gap-2lh mb-lh md:mb-2lh border-b border-hairline">
          <a
            className="tab"
            onClick={() => {
              navigate("/collect/videotovideo1result/demo");
            }}
          ...
          <a
            className="tab"
            onClick={() => {
              navigate("/collect/videotovideo1result/api");
            }}
            style={{ cursor: "pointer" }}
          >
            <svg
          ...
          <a
            className="tab"
            onClick={() => {
              navigate("/collect/videotovideo1result/example  ");
            }}
            style={{ cursor: "pointer" }}
          >
            <svg
          ...
          <a
            className="tab"
            onClick={() => {
              navigate("/collect/videotovideo1result/versions");
            }}
            style={{ cursor: "pointer" }}
          >
            <svg
...
export default VideoToVideo1result;
