  ...
  return (
    <>
      <div
        ...
        data-props="react-component-props-68963be0-0b63-48a6-ae92-af2c0394dcaa"
      >
        <div className="mb-lh">
          <div
            ...
            <div data-reach-tab-panels="">
              ...
              >
                ...
                `}
                      ...
                      {`: {
                `}
                      <span className="hljs-attr">frames_zip</span>:{" "}
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-python !p-0 hljs">
                      ...
                      {`={`}
                      <span className="hljs-string">"frames_zip"</span>:{" "}
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      {`curl -s -X POST \
                -d '{"version": "f55350b82ee3d07b0a2dd329df57dd97dedb5a08daddbdd6580d3cd473eaff1d", "input": {"frames_zip": "..."}}' \
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      cog predict
                      r8.im/fofr/frames-to-video@sha256:f55350b82ee3d07b0a2dd329df57dd97dedb5a08daddbdd6580d3cd473eaff1d
                      -i frames_zip=@path/to/file \ -i frames_urls=... \ -i
                      fps=...
                    </code>
                  </pre>
                  <div className="absolute right-2 top-0 bottom-0 h-full opacity-0 group-hover:opacity-100 flex top-2 items-start">
          ...
          <ul className="content-container">
            <li className="pb-lh border-b border-hairline">
              <a
                className="inline-block no-focus no-underline"
                href="#input-frames_zip"
                id="input-frames_zip"
              >
                <h5 className="pt-lh pb-05lh with-anchor-hash">
                  <code>frames_zip</code> <em className="text-shade">file</em>
                </h5>
              </a>
              <div>ZIP file containing frames</div>
            </li>
            <li className="pb-lh border-b border-hairline">
              <a
                className="inline-block no-focus no-underline"
                href="#input-frames_urls"
                id="input-frames_urls"
              >
                <h5 className="pt-lh pb-05lh with-anchor-hash">
            ...
            <li className="pb-lh border-b border-hairline">
              ...
              >
                <h5 className="pt-lh pb-05lh with-anchor-hash">
                  <code>fps</code> <em className="text-shade">number</em>
                </h5>
              </a>
              <div>Number of frames per second of video</div>
