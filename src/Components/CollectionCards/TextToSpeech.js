    ...
    <>
      <div className="inline-grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="h-40">
          ...
          >
            <img
              ...
              src={require("./Images/TextToSpeech.png")}
            />
          </Link>
        </div>
        <div className="overflow-hidden break-words">
          ...
          <p className="mb-1 m-0">Text-to-speech generation </p>
          <p className="mb-1  text-[#00000073] text-sm">
            <Link className="a-links decoration-[#0000001a]" to="">haoheliu/audio-ldm</Link>
          </p>
        </div>
      </div>
    </>
