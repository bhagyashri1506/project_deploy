      ...
      <main class="layout-main flex-1">
        <header className="flex flex-col md:flex-row md:items-end gap-lh mb-2lh">
          <hgroup className="flex-grow flex flex-col gap-05lh">
              ...
              <div className="flex-shrink-0 ml-3 flex items-center">
                <script
                  dangerouslySetInnerHTML={{
                    __html:
                      '{"content": "arielreplicate/stable_diffusion_infinite_zoom", "label": "Copy model name"}',
                  }}
                  id="react-component-props-d695120e-37dd-48d2-b0f0-f439041fbb92"
                  type="application/json"
                />

                <div
                  data-component="CopyIconButton"
                  data-props="react-component-props-d695120e-37dd-48d2-b0f0-f439041fbb92"
                >
                  <button
            ...
            <p>
              ...
              Use Runway's Stable-diffusion inpainting model to create an
              infinite loop video. Inspired by
              https://twitter.com/matthen2/status/1564608773485895692
            </p>
            ...
            <ul className="flex gap-lh">
              ...
              <li className="whitespace-nowrap">
                ...
                <a
                  href="https://github.com/ArielReplicate/stable-diffusion-infinite-zoom"
                  target="_blank"
                >
                  GitHub
                </a>
              ...
              <li className="whitespace-nowrap">
                ...
                <a
                  href="https://github.com/ArielReplicate/stable-diffusion-infinite-zoom/blob/add-cog/LICENSE"
                  target="_blank"
                >
                  License
                </a>
        ...
        <div className="tabs flex gap-2 md:gap-2lh mb-lh md:mb-2lh border-b border-hairline">
          ...
          >
            ...
            Versions
            <span className="text-shade text-sm font-mono">(a2527c50)</span>
          </a>
        </div>
        <Outlet />
      </main>
