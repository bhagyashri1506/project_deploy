  ...
  return (
    <>
      <div
        ...
        data-props="react-component-props-27bd7111-82ca-4b84-8e1d-bf1fe3f1c466"
      >
        <div className="mb-lh">
          <div
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      {`curl -s -X POST \
                -d '{"version": "a2527c5074fc0cf9fa6015a40d75d080d1ddf7082fabe142f1ccd882c18fce61", "input": {"prompt": "..."}}' \
              ...
              >
                ...
                <div className="group relative">
                  <pre className="code">
                    <code className="language-shell !p-0 hljs">
                      cog predict
                      r8.im/arielreplicate/stable_diffusion_infinite_zoom@sha256:a2527c5074fc0cf9fa6015a40d75d080d1ddf7082fabe142f1ccd882c18fce61
                      -i prompt=... \ -i output_format=... \ -i inpaint_iter=...
                    </code>
                  </pre>
                  <div className="absolute right-2 top-0 bottom-0 h-full opacity-0 group-hover:opacity-100 flex top-2 items-start">
                    <button className="p-2 bg-white border-gray-300 text-gray-800 hover:text-gray-500 focus:outline-none">
          ...
          <ul className="content-container">
            ...
            <li className="pb-lh border-b border-hairline">
              ...
              <div>infinite loop gif or mp4 video</div>
              ...
              <div className="mt-05lh">
                Default value: <code>mp4</code>
              </div>
            </li>
            <li className="pb-lh border-b border-hairline">
              <a
                className="inline-block no-focus no-underline"
                href="#input-inpaint_iter"
              ...
              <div>
                Number of iterations of pasting the image in it's center and
                inpainting the boarders
              </div>
              <div className="mt-05lh">
          ...
          <div className="group relative">
            <pre className="code">
              <code className="language-json !p-0 hljs">
                ...
                <span className="hljs-punctuation">:</span>{" "}
                <span className="hljs-punctuation">{`{`}</span>
                <span className="hljs-attr">"gif"</span>
                <span className="hljs-punctuation">:</span>{" "}
                <span className="hljs-punctuation">{`{`}</span>
                <span className="hljs-attr">"type"</span>
                <span className="hljs-punctuation">:</span>{" "}
                ...
                <span className="hljs-attr">"title"</span>
                <span className="hljs-punctuation">:</span>{" "}
                <span className="hljs-string">"Gif"</span>
                <span className="hljs-punctuation">,</span>
                ...
                <span className="hljs-punctuation">{`}`}</span>
                <span className="hljs-punctuation">,</span>
                <span className="hljs-attr">"mp4"</span>
                <span className="hljs-punctuation">:</span>{" "}
                <span className="hljs-punctuation">{`{`}</span>
                <span className="hljs-attr">"type"</span>
                <span className="hljs-punctuation">:</span>{" "}
                ...
                <span className="hljs-attr">"title"</span>
                <span className="hljs-punctuation">:</span>{" "}
                <span className="hljs-string">"Mp4"</span>
                <span className="hljs-punctuation">,</span>
                <span className="hljs-attr">"format"</span>
                <span className="hljs-punctuation">:</span>{" "}
                <span className="hljs-string">"uri"</span>
