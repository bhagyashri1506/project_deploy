  ...
  return (
    <>
      ...
      <main class="layout-main flex-1">
        <header class="flex flex-col md:flex-row md:items-end gap-lh mb-2lh">
          <hgroup class="flex-grow flex flex-col gap-05lh">
            <div class="flex">
              <div>
                <h3>
                  <span class="text-shade">
                    <a href="/sharaddition">sharaddition</a>
                  </span>
                  <span class="text-shade px-1">/</span>
                  <span class="block md:inline">paraphrase-gpt</span>
                </h3>
              </div>
              <div class="flex-shrink-0 ml-3 flex items-center">
                <div
                  data-component="CopyIconButton"
                  data-props="react-component-props-b2bffaf9-46c0-48be-8d57-0c16a63f701e"
                >
                  <button
                    data-state="closed"
                    class="w-7 h-7 inline-flex items-center justify-center relative hover:bg-gray-100"
                  >
                    ...
                    <svg
                      ...
                      class="pointer-events-none text-shade"
                    >
                      <rect
                        x="9"
                        y="9"
            ...
            <p>
              <span class="mr-2">
                <span class="inline-block rounded-full text-black bg-bgshade small-caps px-3 pb-1">
                  <span class="relative" style={{ top: "0.1em" }}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
            ...
            <ul class="flex gap-lh">
              ...
              <li class="whitespace-nowrap">
                ...
                <a
                  href="https://github.com/Sharaddition/cog-custom-t5"
                  rel="noreferrer"
                  target="_blank"
                >
                  GitHub
        ...
        <div class="tabs flex gap-2 md:gap-2lh mb-lh md:mb-2lh border-b border-hairline">
          ...
          <a onClick={()=>{
            ...
            Versions
            <span class="text-shade text-sm font-mono">(3a66bc6c)</span>
          </a>
        </div>
        <Outlet />
      </main>
...
export default TextToTextresult;
